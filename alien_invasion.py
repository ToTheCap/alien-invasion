...
class AlienInvasion:
    ...
    def __init__(self):
        """Creates main resources for the game"""
        pygame.init()
    ...
    def check_event(self):
        """Watching keyboard and mouse events"""
    ...
    def create_fleet(self):
        ...
        number_rows = avalable_space_y // (2*alien_width)
    ...
    def quit_game(self):
        ...
        with open('Python/Alien Invasion/high_score.txt', 'w') as high_score_file:
            high_score_file.write("{}".format(self.stats.high_score))
